...
\lstset{emph={%  
		definition,where,do,return,if,then,else,partial_function,let,type_synonym
	},emphstyle={\bfseries}%
}%
...
\setlength{\CenteringLeftskip}{0pt plus 0.5em}
\setlength{\CenteringRightskip}{0pt plus 0.5em}
...
\pgfsetlayers{background,main,foreground,legend}
